...
{
    public partial class GestionDonantesFrm : Form
    {
        DataSet ds = new DataSet();
        private int iniciando;
        public GestionDonantesFrm()
        {
            InitializeComponent();
            iniciando = 1;
            this.SuspendLayout();
        ...
        private void cargarDataSetPacientes()
        {
            ...
            SqlCommand command = new SqlCommand("dbo.getDonantesTodos", conn);
            command.CommandType = CommandType.StoredProcedure;
            //command.Parameters.Add("@Nocontrol", SqlDbType.NVarChar).Value = this.txt_nocontrol.Text;
            SqlDataAdapter adapters = new SqlDataAdapter(command);
            //  ds = new DataSet();
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DonantesA abmp = new DonantesA(id);
        ...
        {
            WindowsFormsApplication1.Vista.mayoRediseño.DonantesA pac = new Vista.mayoRediseño.DonantesA();
            pac.Show();
        }
