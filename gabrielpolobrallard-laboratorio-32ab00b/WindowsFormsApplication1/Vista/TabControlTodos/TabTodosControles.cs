...
namespace WindowsFormsApplication1.Vista.TabControlTodos
{
    ...
    public partial class TabTodosControles : Principal
    {
        ...
        private void ControlStockBtn_Click(object sender, EventArgs e)
        {
        ...
        {
            Ventanas.MedicosForm mdf = new Ventanas.MedicosForm();
            mdf.ShowDialog();
        }
        //nuevo analsiis
        private void button4_Click(object sender, EventArgs e)
        {
            Ventanas.analisisFrm nuevoan = new Ventanas.analisisFrm();
            if (nuevoan.ShowDialog() == DialogResult.OK)
            {
            }
        }
